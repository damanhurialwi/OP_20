...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u128.fromString('1000000000000000000000000').toU256();
        const decimals: u8 = 18; // Your decimals.
        const name: string = 'PHAROS'; // Your token name.
        const symbol: string = 'PHRS'; // Your token symbol.
